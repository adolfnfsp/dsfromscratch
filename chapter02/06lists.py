...
copy_of_x = x[:]                    # [-1, 1, 2, ..., 9]
# similarly can slice strings and other "sequential" types

# third argument to indicate stride
every_third = x[::3]                # [-1, 3, 6, 9]
five_to_three = x[5:2:-1]           # [5, 4, 3]

# check list membership with in operator, good for short lists
1 in [1, 2, 3]      # True
0 in [1, 2, 3]      # False
...
x = [1, 2, 3]
x.append(0)         # x is now [1, 2, 3, 0] one item at a time
y = x[-1]           # equals 0
z = len(x)          # equals 4

# unpack list when known how many elements contained otherwise ValueError
x, y = [1, 2]       # now x is 1, y is 2

# use _ for a value you are going to throw away
